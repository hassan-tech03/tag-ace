...
export default function CheckoutPage() {
  const { cartItems, getCartTotal, clearCart, isLoaded } = useCartContext();
  ...
  // Initialize Stripe (not needed for Stripe Checkout)
  // useEffect(() => {
                ...
                <div className="form-section">
                      ...
                      {isFormValid() && (
                        <div className="stripe-checkout-ready">
                          <div className="checkout-info">
                            ...
                            <p>Click &quot;Pay with Stripe&quot; below to be redirected to Stripe&apos;s secure payment page where you can:</p>
                            <ul>
                              <li>✅ Enter your card details securely</li>
                              <li>✅ Review your order total (${total.toFixed(2)})</li>
                              <li>✅ Complete your payment safely</li>
                            </ul>
                            <p className="note">You&apos;ll be redirected back here after payment completion.</p>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  {paymentStatus === 'cancelled' && (
                    <div className="payment-cancelled">
                      <p>⚠️ Payment was cancelled. You can try again or choose a different payment method.</p>
                    </div>
                  )}
                </div>
